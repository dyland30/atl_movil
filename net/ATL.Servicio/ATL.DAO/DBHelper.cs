...
namespace ATL.DAO
{
    public class DBHelper
    {
        ...
        private void Configurar()
        {
            try
            {
                String cadena = ConfigurationManager.ConnectionStrings["connStr"].ConnectionString;
                //String bd_user = ConfigurationManager.AppSettings["bd_user"];
                //String bd_password = ConfigurationManager.AppSettings["bd_password"];
                //String pass_phrase = ConfigurationManager.AppSettings["pass_phrase"];
                //Seguridad seguridad = new Seguridad(pass_phrase);

                //cadena = cadena.Replace("${bd_user}", seguridad.Desencriptar(bd_user));
                //cadena = cadena.Replace("${bd_password}", seguridad.Desencriptar(bd_password));

                this._CadenaConexion = cadena;
            }
